...
func (x *CreateWalletReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_wallet_proto_rawDesc = "" +
	"\n" +
	"\fwallet.proto\x12\x06wallet\"E\n" +
	"\x0fCreateWalletReq\x12\x16\n" +
	...
	"\bwalletId\x18\x01 \x01(\x03R\bwalletId\"a\n" +
	"\rGetWalletResp\x12\x1a\n" +
	"\bwalletId\x18\x01 \x01(\x03R\bwalletId\x12\x18\n" +
	"\abalance\x18\x02 \x01(\x03R\abalance\x12\x1a\n" +
	"\bcurrency\x18\x03 \x01(\tR\bcurrency\"\x81\x01\n" +
	"\vTransferReq\x12\"\n" +
